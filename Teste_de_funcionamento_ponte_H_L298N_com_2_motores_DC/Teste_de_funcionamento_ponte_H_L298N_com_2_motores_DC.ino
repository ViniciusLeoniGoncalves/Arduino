// Definição dos pinos para controle da ponte H
...
//  pinMode(MOTOR2_PWM, OUTPUT);
  ...
  // Inicializando os motores em uma direção para teste
  Serial.begin(9600);
  Serial.println("Iniciando os testes dos motores...");
}
...
void loop() {
 ...
 // analogWrite(MOTOR1_PWM, 255);  // Velocidade máxima
  ...
  delay(2000); // Teste por 2 segundos
